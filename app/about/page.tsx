...
export const metadata: Metadata = {
    title: "About | XenbotAI",
    description: "Learn about XenbotAI, our mission to redefine human-AI interaction, and our commitment to responsible AI.",
};
            ...
            <main className="relative z-10 grow container mx-auto px-6 pt-20 pb-32">
                ...
                <div className="mt-32 max-w-4xl mx-auto text-center glass rounded-3xl p-12">
                    ...
                    <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                        Experience the power of XenbotAI today and see how we can transform the way you work and communicate.
                    </p>
                    <Magnetic>
                        <Link href="/auth">
