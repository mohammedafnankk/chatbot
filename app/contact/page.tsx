...
export const metadata: Metadata = {
    title: "Contact | XenbotAI",
    description: "Get in touch with the XenbotAI team. We're here to answer your questions and explore partnerships.",
};
            ...
            <main className="relative z-10 grow container mx-auto px-6 pt-20 pb-32">
                <div className="max-w-4xl mx-auto text-center animate-fade-in mb-20">
                    ...
                    <p className="text-xl text-muted-foreground mt-6 max-w-2xl mx-auto">
                        Have questions about XenbotAI? Interested in partnering with us? We'd love to hear from you.
                    </p>
                </div>
